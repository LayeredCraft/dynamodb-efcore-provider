...
{
    protected NorthwindWhereQueryDynamoTest(NorthwindQueryDynamoFixture<NoopModelCustomizer> fixture)
        : base(fixture)
        => fixture.ClearSql();
    ...
    public override Task Where_nested_field_access_closure_via_query_cache_error_method_null(bool async)
        => NoSyncTest(async, async a =>
        {
