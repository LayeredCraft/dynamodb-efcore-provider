...
public sealed class DynamoFloatTypeTest(
    DynamoFloatTypeTest.FloatTypeFixture fixture,
    DynamoSpecificationContainerFixture containerFixture)
    : TypeTestBase<float, DynamoFloatTypeTest.FloatTypeFixture>(fixture)
{
    ...
    public override async Task Equality_in_query_with_parameter()
    {
        ...
        var results = await context.Set<TypeEntity<float>>()
    ...
    public override async Task Equality_in_query_with_constant()
    {
        ...
        var entityParameter = Expression.Parameter(typeof(TypeEntity<float>), "e");
        var predicate =
            Expression.Lambda<Func<TypeEntity<float>, bool>>(
                Expression.Equal(
                    Expression.Property(entityParameter, nameof(TypeEntity<float>.Value)),
    ...
    public class FloatTypeFixture : TypeFixtureBase<float>, IDynamoSpecificationFixture
    {
