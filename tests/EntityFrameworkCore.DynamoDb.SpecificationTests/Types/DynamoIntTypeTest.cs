...
public sealed class DynamoIntTypeTest(
    DynamoIntTypeTest.IntTypeFixture fixture,
    DynamoSpecificationContainerFixture containerFixture)
    : TypeTestBase<int, DynamoIntTypeTest.IntTypeFixture>(fixture)
{
    ...
    public class IntTypeFixture : TypeFixtureBase<int>, IDynamoSpecificationFixture
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            modelBuilder.Entity<TypeEntity<int>>().ToTable("IntTypes").HasPartitionKey(e => e.Id);
        }
    }
}
