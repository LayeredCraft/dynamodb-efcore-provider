    ...
    : TypeTestBase<bool, DynamoBoolTypeTest.BoolTypeFixture>(fixture)
{
    ...
    public override async Task Equality_in_query_with_parameter()
    {
        ...
        var results = await context.Set<TypeEntity<bool>>()
    ...
    public override async Task Equality_in_query_with_constant()
    {
        ...
        var entityParameter = Expression.Parameter(typeof(TypeEntity<bool>), "e");
        var predicate =
            Expression.Lambda<Func<TypeEntity<bool>, bool>>(
                Expression.Equal(
                    Expression.Property(entityParameter, nameof(TypeEntity<bool>.Value)),
