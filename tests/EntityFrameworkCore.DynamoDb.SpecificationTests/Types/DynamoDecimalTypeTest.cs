...
public sealed class DynamoDecimalTypeTest(
    DynamoDecimalTypeTest.DecimalTypeFixture fixture,
    DynamoSpecificationContainerFixture containerFixture)
    : TypeTestBase<decimal, DynamoDecimalTypeTest.DecimalTypeFixture>(fixture)
{
    ...
    public void Check_all_tests_overridden()
        => DynamoTestHelpers.AssertAllTestMethodsOverridden(typeof(DynamoDecimalTypeTest));
    ...
    public override async Task Equality_in_query_with_parameter()
    {
        ...
        var results = await context.Set<TypeEntity<decimal>>()
    ...
    public override async Task Equality_in_query_with_constant()
    {
        ...
        var entityParameter = Expression.Parameter(typeof(TypeEntity<decimal>), "e");
        var predicate =
            Expression.Lambda<Func<TypeEntity<decimal>, bool>>(
                Expression.Equal(
                    Expression.Property(entityParameter, nameof(TypeEntity<decimal>.Value)),
    ...
    public class DecimalTypeFixture : TypeFixtureBase<decimal>, IDynamoSpecificationFixture
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            modelBuilder
                .Entity<TypeEntity<decimal>>()
                .ToTable("DecimalTypes")
