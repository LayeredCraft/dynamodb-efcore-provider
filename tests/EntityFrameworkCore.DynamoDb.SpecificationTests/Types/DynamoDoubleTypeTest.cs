...
public sealed class DynamoDoubleTypeTest(
    DynamoDoubleTypeTest.DoubleTypeFixture fixture,
    DynamoSpecificationContainerFixture containerFixture)
    : TypeTestBase<double, DynamoDoubleTypeTest.DoubleTypeFixture>(fixture)
{
    ...
    public override async Task Equality_in_query_with_parameter()
    {
        ...
        var results = await context.Set<TypeEntity<double>>()
    ...
    public override async Task Equality_in_query_with_constant()
    {
        ...
        var entityParameter = Expression.Parameter(typeof(TypeEntity<double>), "e");
        var predicate =
            Expression.Lambda<Func<TypeEntity<double>, bool>>(
                Expression.Equal(
                    Expression.Property(entityParameter, nameof(TypeEntity<double>.Value)),
    ...
    public class DoubleTypeFixture : TypeFixtureBase<double>, IDynamoSpecificationFixture
    {
