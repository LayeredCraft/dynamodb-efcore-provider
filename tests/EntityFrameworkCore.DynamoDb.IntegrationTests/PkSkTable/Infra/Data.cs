...
public static class PkSkItems
{
    ...
    [
        new() { Pk = "P#1", Sk = "0001", IsTarget = false, Category = "alpha" },
        new() { Pk = "P#1", Sk = "0002", IsTarget = true, Category = "bravo" },
        new() { Pk = "P#1", Sk = "0003", IsTarget = false, Category = "charlie" },
        new() { Pk = "P#1", Sk = "0004", IsTarget = true, Category = "delta" },
        new() { Pk = "P#2", Sk = "0001", IsTarget = false, Category = "echo" }
    ];
