    ...
    : SaveChangesTableTestBase(fixture)
{
    ...
    public async Task AddAsync_ProductItem_ScalarsOnly_Persists()
    {
        ...
        AssertSql(
            ...
            VALUE {'Pk': ?, 'Sk': ?, '$type': ?, '$version': ?, 'CategorySet': ?, 'IsActive': ?, 'Metadata': ?, 'Name': ?, 'Price': ?, 'PublishedAt': ?, 'SearchTerms': ?, 'Version': ?, 'Variants': ?}
            """);
    }
    ...
    public async Task AddAsync_SessionItem_PrimitiveCollections_Persist()
    {
        ...
        AssertSql(
            """
            INSERT INTO "AppItems"
            VALUE {'Pk': ?, 'Sk': ?, '$type': ?, '$version': ?, 'Attributes': ?, 'CustomerPk': ?, 'ExpiresAt': ?, 'Flags': ?, 'LastSeenAt': ?, 'Revoked': ?, 'Scopes': ?, 'Version': ?}
            """);
    }
