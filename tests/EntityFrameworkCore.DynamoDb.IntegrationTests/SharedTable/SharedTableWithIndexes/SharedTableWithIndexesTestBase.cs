...
public abstract class SharedTableWithIndexesTestBase(SharedTableWithIndexesDynamoFixture fixture)
    : DynamoDbPerTestResetTestBase<SharedTableWithIndexesDynamoFixture,
        SharedTableWithIndexesDbContext>(fixture)
{
    /// <inheritdoc />
    /// <remarks>
        ...
        await Client.CreateTableAsync(
            new CreateTableRequest
            {
                ...
                [
                    ...
                    new AttributeDefinition
                    {
                        AttributeName = "Priority", AttributeType = ScalarAttributeType.N,
                    },
                ],
                KeySchema =
                [
                ...
                [
                    ...
                    new GlobalSecondaryIndex
                    {
                        ...
                        [
                            ...
                            {
                                AttributeName = "Priority", KeyType = KeyType.HASH,
                            },
                        ],
