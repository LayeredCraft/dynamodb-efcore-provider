...
public static class SimpleItems
{
    ...
    [
        ...
        new()
        {
            ...
            NullableDateTimeOffsetValue = new DateTimeOffset(2026, 1, 2, 11, 30, 0, TimeSpan.Zero),
        ...
        new()
        {
            ...
            NullableDateTimeOffsetValue = new DateTimeOffset(2026, 1, 3, 18, 45, 30, TimeSpan.Zero),
