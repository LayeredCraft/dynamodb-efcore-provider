...
/// <summary>Represents one physical DynamoDB table group and its root-entity source mappings.</summary>
internal sealed record DynamoTableDescriptor(
    string TableName,
    IReadOnlyList<IReadOnlyEntityType> RootEntityTypes,
    IReadOnlyDictionary<string, IReadOnlyList<DynamoIndexDescriptor>> SourcesByEntityTypeName);
