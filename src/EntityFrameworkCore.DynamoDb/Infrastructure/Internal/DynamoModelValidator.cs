    ...
    : ModelValidator(dependencies)
{
    ...
    /// </summary>
    /// <remarks>
    ///     <c>DynamoOwnedEntityTypeValidationConvention</c> rejects owned types at model finalization,
    ///     so by the time this runs, no owned types should exist in a valid model.
