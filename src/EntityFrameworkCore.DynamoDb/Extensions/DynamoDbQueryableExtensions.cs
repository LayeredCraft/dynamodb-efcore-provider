...
public static class DynamoDbQueryableExtensions
{
    ...
    extension<TEntity>(IQueryable<TEntity> source) where TEntity : class
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown when the query source is null.</exception>
        ...
        ///     Thrown when the query source or <paramref name="nextToken" /> is null.
        /// </exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     Thrown when the query source or <paramref name="indexName" /> is null.
        /// </exception>
