...
| `string.Compare(a, b) > 0` (any comparison against 0)                   | `a > b`                                        | Required for string range comparisons; works with `==`, `!=`, `<`, `<=`, `>`, `>=` against sign constants `-1`, `0`, or `1`                                                                                                                                                                                                                                                   |
...
| `string.Contains(s)`                                                    | `contains(attr, ?)`                            | Case-sensitive substring; supports `string`, `char`, and `StringComparison.Ordinal` overloads; no culture or non-ordinal comparison overloads                                                                                                                                                                                                                                 |
...
| `string.StartsWith(s)`                                                  | `begins_with(attr, ?)`                         | Case-sensitive prefix; supports `string`, `char`, and `StringComparison.Ordinal` overloads; no culture or non-ordinal comparison overloads                                                                                                                                                                                                                                    |
