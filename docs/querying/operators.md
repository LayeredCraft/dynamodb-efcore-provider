...
| Offset / paging       | `Skip`, `Take`, `ElementAt`, `ElementAtOrDefault`                                    | DynamoDB has no offset semantics; direct primitive LIST `ElementAt(index)` translates to list indexing             |
