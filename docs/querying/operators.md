...
| --------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| Element operators     | `Any`, `All` except supported inline finite collection predicate rewrites    | General server-side element operators are unsupported; use `AsAsyncEnumerable()` then LINQ-to-objects |
