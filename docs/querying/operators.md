...
| `string.Compare(a, b) > 0`          | `a > b`                                        | Required for string range comparisons; works with `==`, `!=`, `<`, `<=`, `>`, `>=` against sign constants `-1`, `0`, or `1`                                                                                                                                                           |
| `a.CompareTo(b) > 0`                | `a > b`                                        | Same as above; `0 < a.CompareTo(b)` form also supported (operands mirrored)                                                                                                                                                                                                           |
