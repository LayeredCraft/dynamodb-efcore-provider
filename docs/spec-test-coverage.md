...
1. `TypeTestBase` — generic scalar type fixture matrix; `DynamoIntTypeTest`, `DynamoStringTypeTest`, `DynamoBoolTypeTest`, and `DynamoGuidTypeTest` cover first scalar fixtures, remaining scalar fixtures need separate support decisions
