...
1. `TypeTestBase` — generic scalar type fixture matrix; numeric/string/bool/Guid/DateTime scalar fixtures are covered, remaining temporal and binary fixtures need separate support decisions
