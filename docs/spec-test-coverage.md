...
| `ComplexTypesTrackingTestBase`                       |     128 |   ✓    |    ✗    | Complex type change tracking; custom null/default persistence variants are covered outside inherited spec bodies where upstream uses unsupported scan/sync shapes                                                      |
