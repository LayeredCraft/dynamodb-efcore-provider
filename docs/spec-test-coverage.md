...
1. `TypeTestBase` — generic scalar type fixture matrix; `DynamoIntTypeTest`, `DynamoStringTypeTest`, `DynamoBoolTypeTest`, `DynamoGuidTypeTest`, `DynamoByteTypeTest`, `DynamoShortTypeTest`, `DynamoLongTypeTest`, and `DynamoDecimalTypeTest` cover first scalar fixtures, remaining scalar fixtures need separate support decisions
