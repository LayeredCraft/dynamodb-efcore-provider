...
Complex property-to-property equality is supported, but equality against a complex object constant or parameter is not translated. Compare individual nested members instead.
